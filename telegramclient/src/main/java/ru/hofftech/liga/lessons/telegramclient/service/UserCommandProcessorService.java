    ...
    public String processRawInput(String userInput) {
        try {
            ...
            return switch (command.getCommand()) {
                ...
                case Command.LOAD_PARCELS -> parcelLoaderClientService.load(LoadParcelsRequestDto.fromArgsMap(command.getArgs()));
                case Command.UNLOAD_TRUCKS -> parcelLoaderClientService.unload(UnloadTrucksRequestDto.fromArgsMap(command.getArgs()));
